...
<h2 class="head" style="margin-top:40px; margin-bottom:20px"> Assignment Management </h2>
...
<table id="myiddata" class="display responsive nowrap" style="width:100%">
  <thead>
   <tr>
     <th>SECTION</th>
     <th>SUBJECT</th>
...
?>
  <tr>
   ...
   <td data-label="Given" ><a href='teacher_view_assignments.php?tc_id=<?php echo $row['teacher_class_id']; ?>'class="btn btn-primary" >OPEN</a></td>
  </tr>
<?php
  }
?>
