...
<h2 style="margin-top:40px; margin-bottom:20px" class="head">Exam Management</h2>
...
<?php while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
    <tr>
     ...
     <td data-label="GIVEN"><a href='teacher_view_exam.php?tc_id=<?php echo $row['teacher_class_id']; ?>'class="btn btn-primary" >OPEN</a></td>
    </tr>
  <?php
    }
  ?>
