...
?>
          <div class="container-xxl">
            <h2 style="margin-top:40px; margin-bottom:20px" class="head">Profile</h2>
                  ...
                  <div class="col-lg-4">
                    <div class="card shadow-sm">
                     ...
                     <a style="width: 140px;"class="btn btn-primary" name="pic_change" href="profile_pic_change.php">Profile Picture</a>
                      ...
                      <div class="card-body">
                        <h5></h5>
                        <p class="mb-0"><strong class="pr-1"> School ID: </strong><?php echo $row['school_id'] ?></p>
                        <p class="mb-0"><strong class="pr-1">Login ID: </strong><?php echo $row['teacher_id'] ?></p>
