...
<h2 class="head" style="margin-top:40px; margin-bottom:20px"> Module Management </h2>
...
$stmt = mysqli_stmt_init($conn);
  if(!mysqli_stmt_prepare($stmt, $sql)) {
    ...
    //detemernine in no dat
}
?>

<div class="table-responsive">
<table id="mdata" class="display responsive nowrap" style="width:100%">
  <thead>
   <tr>
    <th>SECTION </th>
    <th>SUBJECT </th>
...
?>
  <tr>
   ...
   <td data-label="Modules" ><a href='teacher_view_modules.php?tc_id=<?php echo $row['teacher_class_id']; ?>'class="btn btn-primary" >OPEN</a></td>
  </tr>
<?php
  }
?>
