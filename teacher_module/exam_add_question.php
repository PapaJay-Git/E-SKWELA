...
$examTypes = $conn->query($sqlExamtype);
 ...
 <div class="container-xxl">
   <h2 style="margin-top:40px; margin-bottom:20px" class="head">EXAM QUESTIONS</h2>
                 ...
                 <div class="Scriptcontent">
                   ...
                   <div class="card shadow-sm" id="formm" style="display: none;">
                     ...
                     <div class="card-body pt-0">
                       <?php $four = 4; ?>
                       <form onsubmit="return clicked()" id="update_exam_form"action="exam_add_query.php?view_id=<?php echo $four ?>&exam_id=<?php echo $examiddd ?>&tc_id=<?php echo $iddd ?>" method="POST">
                       <table class="table table-bordered">
                         <tr>
                           ...
                           <td>
                             <div class="form-group">
                               <textarea name="exam_title" maxlength="300" class="form-control" rows="2"required><?php echo $examrow['exam_title']?></textarea>
                             </div>
                         </td>
                         </tr>
                         <tr>
                           ...
                           <td><div class="form-group">
                             <textarea class="form-control" name="exam_description" maxlength="2500" rows="4" required><?php echo $examrow['exam_description']?> </textarea>
                           </div></td>
                         </tr>
                         <tr>
                           ...
                           <td><div class="form-group">
                             ...
                             value="<?php echo $examrow['start_date']?> " onpaste="return false;" onDrag="return false" onDrop="return false" autocomplete="off" required>
                           </td>
                           </div>
                         </td>
                         </tr>
                         <tr>
                           ...
                           <td><div class="form-group">
                             ...
                             value="<?php echo $examrow['deadline_date']?> " onpaste="return false;" onDrag="return false" onDrop="return false" autocomplete="off" required>
                           </td>
                           </div>
                         </td>
                         </tr>
                         <tr>
                           ...
                           <td><div class="form-group">
                             ...
                             value="<?php echo $examrow['max_attempt']?>" onDrag="return false" onDrop="return false" autocomplete="off" placeholder="Attempt" required>
                           </td>
                           </div>
                         </td>
                         </tr>
                         <tr>
                           ...
                           <td><div class="form-group">
                             ...
                             value="<?php echo $examrow['timer']?>" onDrag="return false" onDrop="return false" autocomplete="off" placeholder="Attempt" required>
                           </td>
                           </div>
                         </td>
                         </tr>
                       ...
                       <div class="row">
                         ...
                         <input type="hidden" name="update_exam" value="Update">
                       </div>
                       </form>
                     </div>
                   </div>
                     ...
                     <div class="card-body pt-0">
                       <div class="row">
                         ...
                         <div class="col-md-4 btn-group" role="group">
                           ...
                           <input type="button"  style="width: 100px;" id="share" class="btn btn-primary" onclick="showexam()" value="Share">
                           <a href="teacher_view_exam.php?tc_id=<?php echo $row['teacher_class_id']; ?>" class="btn btn-danger" >BACK</a>
                         </div>
                       </div>
                       <?php
                       require_once "includes_exam_create.php";
                       require_once "includes_exam_created.php";
                       require_once "includes_exam_share.php";
...
function clicked() {
 swal.fire({
   title: "Are you sure?",
   text: "You are about to update this exam. Are you sure you want to do that?",
   icon: "question",
   showCancelButton: true,
   confirmButtonText: "Update"
 }).then(function (result){
   if (result.isConfirmed) {
         document.getElementById("update_exam_form").submit();
...
return false;
  ...
  function load() {
    var share = document.getElementById('share_exam');
...
<script type="text/javascript" src="exam_add_question_query.js">
</script>
<?php
