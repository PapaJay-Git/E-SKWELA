                          ...
                          <div class="Scriptcontent">
                            ...
                            <div class="card shadow-sm">
                              ...
                              <div class="card-body pt-0">
                                <form onsubmit="return clicked()" id="form_info" class="" action="profile_update_edit.php" method="post">
                                <table class="table table-bordered">
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <textarea name="address" class="form-control" id="exampleFormControlTextarea1" rows="2"required><?php echo $row['t_adress'] ?></textarea>
                                      </div>
                                  </td>
                                  </tr>
                                  <tr>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4 btn-group" role="group">
                                    ...
                                    <input type="hidden" name="edit_profile"  value="3d">
