...
?>
<div class="container">
  <h2 class="head" style="margin-top:40px; margin-bottom:20px">CREATE SECTION FOR GRADE 7</h2>
  <hr size="4" width="100%" color="grey">
                    <form onsubmit="return clicked()" id="formm" action="create_section_7_query.php" method="post">
                        <div class="row">
                          ...
                          <div class="col-md-4 btn-group" role="group">
                            ...
                            <input type="hidden" name="add_section_7" value="erer">
                            <a href="section_7.php"class="btn btn-danger">BACK</a>
                          </div>
                        </div>
                      <div class="multi-field-wrapper">
                        <div class="multi-fields">
                          <div class="multi-field" style="margin-top: 7px">
                            <label>SECTION NAME</label><br>
                            <input type="text" id="name"name="section_name_7[]"style="width: 60%;" required placeholder="NAME...">
...
swal.fire({
title: "Are you sure?",
text: "You are about to create "+num2+" Section for grade 7. Are you sure you want to do this?",
icon: "question",
