              ...
              <div class="row">
                <div class="col-lg-100">
                  <div class="card shadow-sm">
                    <div class="card-body">
                       <form onsubmit="return clicked()" id="form" action="edit_section_7_query.php" method="post">
                         <div class="card-body pt-0">
                           <table class="table table-bordered">
                             <tr>
                               ...
                               <td>
                                 <?php if ($row['ste'] == 1) {
                                   ...
                                   <input type="hidden" name="section_name_7" value="STE">
                                   <?php
                                   ...
                                   ?>
                                   <input type="text" name="section_name_7" class="form-control"value="<?php echo $row['section_code'] ?>" required>
                                   <?php
                             ...
                             <?php while ($row2 = mysqli_fetch_assoc($result2)) {
                               ...
                               <tr>
                                 <th width="30%">
                                   <input type="hidden" name="subject_id_7[]" value="<?php echo $row2['subject_id']; ?>">
                                   <?php echo $row2['subject_title']; ?></th>
                                 <td width="2%">:</td>
                                 <td>
                                   <select name="teacher_id_7[]" class="form-control" required>
                           ...
                           <input type="hidden" name="class_id_7" value="<?php echo $row['class_id'] ?>">
                           <input type="hidden"  name="update_section_7" value="sections_77">
