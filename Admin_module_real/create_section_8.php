...
?>
<div class="container">
  <h2 class="head" style="margin-top:40px; margin-bottom:20px">CREATE SECTION FOR GRADE 8</h2>
  <hr size="4" width="100%" color="grey">
                    <form onsubmit="return clicked()" id="formm" action="create_section_8_query.php" method="post">
                        <div class="row">
                          ...
                          <div class="col-md-4 btn-group" role="group">
                            ...
                            <input type="hidden" name="add_section_8" value="">
                            <a href="section_8.php"class="btn btn-danger">BACK</a>
                          </div>
                        </div>
                      <div class="multi-field-wrapper">
                        <div class="multi-fields">
                          <div class="multi-field" style="margin-top: 8px">
                            <label>SECTION NAME</label><br>
                            <input type="text" id="name" name="section_name_8[]"style="width: 60%;" required placeholder="NAME...">
...
swal.fire({
title: "Are you sure?",
text: "You are about to create "+num2+" Section for grade 8. Are you sure you want to do this?",
icon: "question",
