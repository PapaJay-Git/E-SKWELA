...
?>
          <div class="container-xxl">
            <h2 style="margin-top:40px; margin-bottom:20px" class="head" id="h2"><p id="pp" style="display:inline">STUDENTS FROM STE THAT IS NOW IN GRADE 8</h2>

            <hr size="4" width="100%" color="grey">
        <form class="transfer_form" id="transfer"action="previous_8_query.php" method="post">
                  ...
                  <a href="previous.php" class="btn btn-danger">BACK</a>
                    ...
                    <select id="card2"class="form-control" name="section_id">
                      <option default selected value disabled>-- GRADE 8 SECTIONS YOU CAN TRANSFER TO--</option>
                  ...
                  $(document).ready(function() {
                      $('#myidata2').DataTable( {
                        ...
                        lengthMenu: [[100, -1], [100, "All"]],
                         ...
                         {
                           extend: 'print',
                           title: 'Previous STE 8 List id:<?php $rand = substr(uniqid('', true), -5); echo $rand;?>'
                         },
                         {
                           extend: 'excelHtml5',
                           title: 'Previous STE 8 List id:<?php $rand = substr(uniqid('', true), -5); echo $rand;?>'
