...
$section_id = $_POST['class_id_9'];
if (isset($_POST['class_id_9']) && isset($_POST['update_section_9']) && isset($_POST['section_name_9']) && isset($_POST['subject_id_9']) && isset($_POST['teacher_id_9'])) {
  $section_code =  strtoupper(ltrim(htmlspecialchars($_POST['section_name_9'])));
  $num = 9;
  $section_name = $section_code." ".$num;
  $subjects = $_POST['subject_id_9'];
  $teachers = $_POST['teacher_id_9'];
  $N = count($subjects);
  $N2 = count($subjects);
  ...
  //loop to on how man1y classes do the admin want to add this exam. Based on the check boxes selected
    ...
    header("location:edit_section_9.php?section_id=$section_id&error=number");
    exit();
    }
    ...
    if(!mysqli_stmt_prepare($stmt, $sql)) {
        ...
        echo $conn->error;
        header("location: edit_section_9.php?section_id=$section_id");
        exit();
      }
        ...
        if ($result1->num_rows > 0) {
          $_SESSION['error']= "It looks like $section_code is already exist in grade 9 section!";
         header("location: edit_section_9.php?section_id=$section_id");
         exit();
        }
  }
 ...
 header("location: edit_section_9.php?section_id=$section_id&notset");
 exit();
}
