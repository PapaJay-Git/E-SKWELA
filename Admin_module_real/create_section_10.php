...
?>
<div class="container">
  <h2 class="head" style="margin-top:40px; margin-bottom:20px">CREATE SECTION FOR GRADE 10</h2>
  <hr size="4" width="100%" color="grey">
                    <form onsubmit="return clicked()" id="formm" action="create_section_10_query.php" method="post">
                        <div class="row">
                          ...
                          <div class="col-md-4 btn-group" role="group">
                            ...
                            <input type="hidden" name="add_section_10" value="sss">
                      ...
                      <div class="multi-field-wrapper">
                        <div class="multi-fields">
                          <div class="multi-field" style="margin-top: 10px">
                            ...
                            <input type="text" id="name"name="section_name_10[]"style="width: 60%;" required placeholder="NAME...">
...
swal.fire({
title: "Are you sure?",
text: "You are about to create "+num2+" Section for grade 10. Are you sure you want to do this?",
icon: "question",
