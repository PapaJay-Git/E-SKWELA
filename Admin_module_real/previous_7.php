...
?>
          <div class="container-xxl">
            <h2 style="margin-top:40px; margin-bottom:20px" class="head" id="h2"><p id="pp" style="display:inline">STUDENTS FROM STE THAT IS NOW IN GRADE 7</h2>

            <hr size="4" width="100%" color="grey">
        <form class="transfer_form" id="transfer"action="previous_7_query.php" method="post">
                  ...
                  $(document).ready(function() {
                      $('#myidata2').DataTable( {
                        ...
                        lengthMenu: [[100, -1], [100, "All"]],
                         ...
                         {
                           extend: 'print',
                           title: 'Previous STE 7 List id:<?php $rand = substr(uniqid('', true), -5); echo $rand;?>'
                         },
                         {
                           extend: 'excelHtml5',
                           title: 'Previous STE 7 List id:<?php $rand = substr(uniqid('', true), -5); echo $rand;?>'
