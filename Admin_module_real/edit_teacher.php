...
<?php
  ...
  if(!mysqli_stmt_prepare($stmt, $sql)) {
      ...
      header("location: teachers.php?view=failed");
      exit();
    }
      ...
      $_SESSION['error'] = "It looks like this teacher is already been deleted!";
        header("location: teachers.php?view=failed");
        exit();
    }
?>
          <div class="container-xxl">
            <h2 style="margin-top:40px; margin-bottom:20px" class="head" id="h2">CHANGE TEACHER DETAILS</h2>
            ...
            <button type="button" class="btn btn-primary" onClick="showPassword()">Password</button>
              ...
              <!-- teacher Profile -->
            <div class="teacher-profile py-4" style="display: block;" id="nameform">
              <div class="container-md">
                <div class="row">
                  <div class="col-lg-100">
                    <div class="card shadow-sm">
                      <div class="card-body">
                         <form onsubmit="return clicked()" id="formpassword" action="edit_teacher_query.php" method="post">
                           <div class="form-group">
                             ...
                             <input type="hidden" name="update_teacher_name" value="hello">
          ...
          <div class="teacher-profile py-4" style="display: none;" id="passform">
            <div class="container-md">
              <div class="row">
                <div class="col-lg-100">
                  <div class="card shadow-sm">
                    <div class="card-body">
                       <form onsubmit="return clicked2()" id="formpassword2"action="edit_teacher_query.php" method="post">
                         <div class="form-group">
                         ...
                         <div class="form-group">
                           ...
                           <button type="submit" class="btn btn-primary" >UPDATE</button>
                           <input type="hidden" name="update_teacher_password" value="hello">
                           <a href="teachers.php" class="btn btn-danger">BACK</a>
                           </div>
                        </form>
                    </div>
