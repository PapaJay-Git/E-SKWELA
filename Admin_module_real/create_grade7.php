...
<?php
  ...
  $queryy ="SELECT * FROM subjects WHERE grade = 7 AND ste = 1;";
  $connect = $conn->query($queryy);
?>
<div class="container">
  <h2 class="head" style="margin-top:40px; margin-bottom:20px">CREATE GRADE 7 SUBJECT</h2>
  <hr size="4" width="100%" color="grey">
                    <form onsubmit="return clicked()" id="formm" action="create_grade7_query.php" method="post">
                      <div class="row">
                        <div style="width: 60%; margin-bottom: 10px">
                          ...
                          if ($connect->num_rows < 1) {
                            ...
                            <select class="form-control" name="STE">
                             <option default selected disabled>--GRADE 7 SUBJECT--</option>
                          ...
                          <div class="col-md-4 btn-group" role="group">
                            ...
                            <input type="hidden" name="add_grade7" value="retgr">
...
swal.fire({
title: "Are you sure?",
text: "You are about to create "+num2+" Subject for grade 7. Are you sure you want to do this?",
icon: "question",
