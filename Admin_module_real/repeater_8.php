...
?>
          <div class="container-xxl">
            <h2 style="margin-top:40px; margin-bottom:20px" class="head" id="h2"><p id="pp" style="display:inline">GRADE 8 REPEATERS</h2>

            <hr size="4" width="100%" color="grey">
        <form class="transfer_form" id="transfer" action="repeater_8_query.php" method="post">
