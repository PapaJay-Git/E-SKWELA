...
?>
<div class="container">
  <h2 class="head" style="margin-top:40px; margin-bottom:20px">CREATE TEACHER ACCOUNT</h2>
  <hr size="4" width="100%" color="grey">
                    <form onsubmit="return clicked()" id="formm" action="create_teachers_query.php" method="post">
                        <div class="row">
                          ...
                          <div class="col-md-4 btn-group" role="group">
                            ...
                            <input type="hidden" name="add_teacher" value="basta">
                            <a href="teachers.php"class="btn btn-danger">BACK</a>
                          </div>
                        </div>
                      <label>Teacher's Name and Password</label><br>
...
function clicked() {
  ...
  {  }
    ...
    Swal.fire({ title: "EXIST", text: "It looks like this ("+result+") Teacher Number is already added before. You cannot duplicate teacher numbers" });
  }
  },
...
swal.fire({
title: "Are you sure?",
text: "You are about to create "+num2+" Teacher account. Are you sure you want to do this?",
icon: "question",
