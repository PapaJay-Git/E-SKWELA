...
<?php
  ...
  if(!mysqli_stmt_prepare($stmt, $sql)) {
      ...
      header("location: section_7.php?view=failed");
      exit();
    }
      ...
      $_SESSION['error'] = "It looks like this section is missing or this section is not a grade 7 section!";
        header("location: section_7.php?view=failed");
        exit();
  ...
  if(!mysqli_stmt_prepare($stmt, $sql)) {
      ...
      mysqli_stmt_bind_param($stmt, "i", $grade8);
      mysqli_stmt_execute($stmt);
...
?>
  ...
  <form class="promote_form" id="promote" style="display:none;"action="promote_section_7_query.php" method="post">
            ...
            <a href="section_7.php" class="btn btn-danger">BACK</a>
            </div>
              <select id="card"class="form-control" name="section_id">
                <option default selected value disabled>-- GRADE 8 SECTIONS YOU CAN PROMOTE STUDENTS TO --</option>
                <?php
                $result2->data_seek(0);
        ...
        <table id="myidata" class="display responsive" style="width:100%">
            ...
            <tr>
              ...
              while ($row77 = mysqli_fetch_assoc($result44)) {
                      ...
                      $stmt = mysqli_stmt_init($conn);
                      mysqli_stmt_prepare($stmt, $sql);
                      mysqli_stmt_bind_param($stmt, "ii", $students['student_id'], $row77['subject_id']);
                      mysqli_stmt_execute($stmt);
        ...
        <form class="transfer_form" id="transfer" style="display:block;"action="promote_section_7_query.php" method="post">
                  <div class="btn-group" role="group" style="float:right; margin-bottom:10px">
                  ...
                  <a href="section_7.php" class="btn btn-danger">BACK</a>
                    ...
                    <select id="card2"class="form-control" name="section_id">
                      <option default selected value disabled>-- GRADE 7 SECTION YOU CAN TRANSFER TO--</option>
