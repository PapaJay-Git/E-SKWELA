...
?>
<div class="container">
  <h2 class="head" style="margin-top:40px; margin-bottom:20px">GRADE 9 SUBJECTS</h2>
                  <hr size="4" width="100%" color="grey">
  <form class="delete_form" action="delete_grade9.php" method="post">
                  <div class="row" style="margin-bottom:10px;">
                    <div class="col-md-8"><h5> </h5></div>
                    <div class="col-md-4 btn-group" role="group">
                      <button onclick="location.href='create_grade9.php'" type="button" class="btn btn-primary"><i class="fa fa-plus-circle"><span style="font-family: 'Poppins', sans-serif; font-weight: bold;" >SUBJECT</span></i></button>
                  ...
                  <table id="myidata" class="display responsive" style="width:100%">
                      ...
                      <?php
                      while ($grade9 = mysqli_fetch_assoc($result)) {
                       ?>
                      <tr>
                        <td><input type="checkbox" id="ckx" name="delete_grade9[]" value="<?php echo $grade9['subject_id'];?>"></td>
                        <td><?php echo $grade9['subject_id']; ?></td>
                        <td><?php echo $grade9['subject_code'];?></td>
                        <td><?php echo $grade9['subject_title']; ?></td>
                        <td>
                          <?php if ($grade9['ste'] == 1) {
                            echo "YES";
                          }else {
                        ...
                        <td><a href="edit_grade9.php?subject_id=<?php echo $grade9['subject_id'];; ?>" class="btn btn-primary">Edit</a></td>
                      </tr>
                  ...
                  $(document).ready(function() {
                      $('#myidata').DataTable( {
                        ...
                        lengthMenu: [[10, 25, 50, 100, -1], [10, 25, 50, 100, "All"]],
                         ...
                         {
                           extend: 'print',
                           title: 'Grade 9 subjects id:<?php $rand = substr(uniqid('', true), -5); echo $rand;?>'
                         },
                         {
                           extend: 'excelHtml5',
                           title: 'Grade 9 subjects id:<?php $rand = substr(uniqid('', true), -5); echo $rand;?>'
                  ...
                  //for notification before deleting the grade9
                      ...
                      $('.delete_form #btn-ok').click(function(e) {
                        ...
                        //For number of grade9 being deleted
                          ...
                          var num = num2 - minus;
                          swal.fire({
                            title: "DELETE "+num+" GRADE 9 SUBJECTS?",
                            text: "Are you sure you want to delete these number ("+num+") of grade 9 subjects? This will also delete all of the data from these subjects, "+
