...
<?php
  ...
  if(!mysqli_stmt_prepare($stmt, $sql)) {
      ...
      mysqli_stmt_bind_param($stmt, "i", $grade11);
      mysqli_stmt_execute($stmt);
...
?>
  ...
  <form class="promote_form" id="promote" style="display:none;"action="promote_section_10_query.php" method="post">
            ...
            <a href="section_10.php" class="btn btn-danger">BACK</a>
              ...
              <select id="card"class="form-control" name="section_id">
                <option default selected value disabled>-- GRADE 11 SECTIONS YOU CAN PROMOTE STUDENTS TO --</option>
                <?php
                $result2->data_seek(0);
        ...
        <form class="transfer_form" id="transfer" style="display:block;"action="promote_section_10_query.php" method="post">
                  <div class="btn-group" role="group" style="float:right; margin-bottom:10px">
                  ...
                  <a href="section_10.php" class="btn btn-danger">BACK</a>
                    ...
                    <select id="card2"class="form-control" name="section_id">
                      <option default selected value disabled>-- GRADE 10 SECTION YOU CAN TRANSFER TO--</option>
